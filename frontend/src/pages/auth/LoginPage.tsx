          ...
          <Card className="shadow-xs border-zinc-200">
            <CardHeader className="pb-3 border-none">
              ...
              <CardDescription className="text-xs text-zinc-500 mt-1">
                Clerk publishable key (<code className="text-[11px] bg-zinc-100 px-1 py-0.5 rounded">VITE_CLERK_PUBLISHABLE_KEY</code>) is currently not configured in <code className="text-[11px] bg-zinc-100 px-1 py-0.5 rounded">.env</code>.
              </CardDescription>
            </CardHeader>
