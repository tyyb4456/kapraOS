      ...
      <div className="w-full space-y-1">
        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            ref={ref}
            disabled={disabled}
            className={`w-full h-9 rounded-md border bg-white dark:bg-zinc-950 px-3 py-1 text-sm text-zinc-900 dark:text-zinc-100 placeholder:text-zinc-400 dark:placeholder:text-zinc-500 transition-colors focus:outline-none focus:ring-1 ${
              error
            ...
            } ${leftIcon ? 'pl-8' : ''} ${rightIcon ? 'pr-8' : ''} disabled:bg-zinc-50 dark:disabled:bg-zinc-900 disabled:text-zinc-500 disabled:cursor-not-allowed ${className}`}
            {...props}
          />
          {rightIcon && (
